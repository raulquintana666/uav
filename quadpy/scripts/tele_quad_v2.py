...
def start():
	...
	while not rospy.is_shutdown():
		...
		pitch_adjust = pitch_proportional + pitch_integral
		...
		##################### MOTOR COMMANDS #################
		motor1 = throttle_in - roll_adjust
		motor2 = throttle_in - roll_adjust
		motor3 = throttle_in + roll_adjust
		motor4 = throttle_in + roll_adjust
